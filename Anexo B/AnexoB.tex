...
En este contexto, diversos estudios, como el publicado por \textbf{\textit{\cite{chen_2cfastica_2024}}}, han explorado la viabilidad de utilizar ICA para descomponer señales EMG multicanal y aislar componentes asociados a músculos individuales o grupos de unidades motoras. Estos trabajos muestran que la estructura de mezcla lineal de la sEMG (EMG no invasivo), junto con la independencia relativa entre fuentes fisiológicas, convierte a ICA en un candidato adecuado para mejorar la capacidad de interpretación de las grabaciones. 

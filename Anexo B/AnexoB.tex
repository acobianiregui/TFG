...
No obstante, su aplicación en el ámbito de la electromiografía ha recibido una atención más limitada. 

Este hueco resulta especialmente relevante si se considera el creciente interés clínico por la evaluación de músculos reinervados, en los cuales la actividad de los nervios redirigidos presenta patrones alterados que podrían beneficiarse de métodos avanzados de separación de fuentes.
...
No obstante, existen desafíos que requieren una mayor investigación, especialmente en términos de robustez, reproducibilidad y validación fisiológica de los componentes obtenidos. \space \space \space
%%%%%%%%%%%%%%
...
No obstante, al hacer uso de músculos auxiliares como bioamplificadores, estos interaccionan con el nervio redirigido y modifican la forma y características de la señal emitida. (A expandir) %Feedback Romano?

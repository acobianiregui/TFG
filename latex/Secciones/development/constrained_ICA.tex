...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth]{figuras/constrained/constrained_conceptual_graph.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth,height=6cm]{figuras/constrained/comparison_beta_03_tau_5.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth]{figuras/constrained/comparison_beta_05_tau_5_with_delayed_regression.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{
        \includegraphics[width=\linewidth, height=6.5cm]{figuras/constrained/comparison_beta_05_tau_0.png}
    }

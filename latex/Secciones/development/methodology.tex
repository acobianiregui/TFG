...
\input{latex/Secciones/development/problem_model}
\section{Approach}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth ]{figuras/methodology/chronogram_work.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width= 0.7\linewidth, height=7cm]{figuras/methodology/TMR_tr2_diagram.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth ]{figuras/methodology/artificial_dataset_example.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth ]{figuras/methodology/channel_corr_matrix.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{
        \includegraphics[width=\linewidth ]{figuras/methodology/signal_conditioning.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth ]{figuras/methodology/mixing_example.png}
    }

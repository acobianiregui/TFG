...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth,height=12.1cm]{figuras/sobi_results_TMR.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth, height=7cm]{figuras/TMR_norm_autocorr.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth,height=6cm]{figuras/artificial_norm_autocorr.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth]{figuras/sobi_results_artificial_1.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth]{figuras/sobi_results_artificial_2.png}
    }

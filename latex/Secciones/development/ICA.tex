...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth, height=8.5cm]{figuras/det_close_to_0.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth]{figuras/beta_effect_s1_corr_weak_source.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth, height=8.5cm]{figuras/beta_effect_s1_snr_weak_source.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth, height=8.5cm]{figuras/beta_effect_s1_corr.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth]{figuras/beta_effect_s1_snr.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth]{figuras/ica_result_ideal.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth]{figuras/ica_result_noise.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth]{figuras/ica_result_noise_delay_09.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth,height=9cm]{figuras/ica_result_noise_delay.png}
    }

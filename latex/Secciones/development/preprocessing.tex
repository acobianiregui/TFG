...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1.25\linewidth]{figuras/preprop_diagram.png}%
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1\linewidth]{figuras/notch_mag_response.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1\linewidth]{figuras/notch_group_delay.png}%
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1\linewidth]{figuras/mag_phase_response.png}%
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1\linewidth]{figuras/group_delay.png}%
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1\linewidth]{figuras/filtering_envelop_comparison.png}%
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1\linewidth]{figuras/filtering_frequency_comparison.png}%
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1\linewidth]{figuras/whitening_effect.png}%
    }

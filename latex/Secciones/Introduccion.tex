...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth, height=5cm]{figuras/introduction/cocktail_party.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth, height=6cm ]{figuras/introduction/iit_schematics.jpg}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth, height=4.5cm ]{figuras/introduction/RPNI_procedure.png}
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=\linewidth, height=6.5cm ]{figuras/introduction/VDMT_diagram_modified.png}
    }
